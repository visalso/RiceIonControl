...
def loadimg(filename):
    ...
    return ma.masked_where(imgYb == 0, imgYb / 1000.0 - 1.0), ma.masked_where(imgRb == 0, imgRb / 1000.0 - 1.0)
...
def simultanous_write_read():
    ...
    savethread = threading.Thread(target = test_save, args = ('img/testsave.sis', rawimg), )

    loadthread = threading.Thread(target = test_read, args = ('img/testsave.sis',), )
